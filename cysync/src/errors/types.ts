export enum CysyncError {
  ...
  SENX_TXN_BROADCAST_FAILED = 'DS_OPTS_1003',
  ...
  INCOMPATIBLE_DEVICE = 'HD_INIT_2151',
  INCOMPATIBLE_DESKTOP = 'HD_INIT_2152',
  INCOMPATIBLE_DEVICE_AND_DESKTOP = 'HD_INIT_2153'
}

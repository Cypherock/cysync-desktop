...
const en: I18nStrings = {
  ERRORS: {
    ...
    DEVICE_INFO_UNKNOWN_ERROR: `Some internal error occurred, disconnect and reconnect the X1 wallet.`,
    DEVICE_NOT_IN_UPDATE_RECEIVING_MODE: `Some internal error occurred, disconnect and reconnect the X1 wallet.`,
    ...
    ADD_WALLET_UNKNOWN_ERROR: `Some internal error occurred, disconnect and reconnect the X1 wallet then try adding a wallet account`,
    ...
    ADD_COIN_UNKNOWN_ERROR: `Some internal error occurred, disconnect and reconnect the X1 wallet then try adding coins.`,
    ...
    CARD_AUTH_UNKNOWN_ERROR:
      'Some internal error occurred, Retry the operation.',
    ...
    DEVICE_UPGRADE_UNKNOWN_ERROR: `Some internal error occurred, disconnect and reconnect the X1 wallet then retry updating the X1 wallet.`,
    ...
    LOG_FETCHER_UNKNOWN_ERROR:
      'Some internal error occurred, reattach the X1 wallet logs.',

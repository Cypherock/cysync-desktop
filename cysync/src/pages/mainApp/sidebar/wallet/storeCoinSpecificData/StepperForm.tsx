...
import { useCoinSpecificDataContext } from '../../../../../store/provider';
...
const STEP_PREFIX = 'WalletStoreCoinSpecificData-Step';
...
const PREFIX = 'WalletStoreCoinSpecificData';
...
const ReceiveForm: React.FC<StepperProps> = ({
  ...
  const handleErrorBoxClose = () => {
    coinSpecificData.setErrorMessage('');
  ...
  useEffect(() => {
    if (coinSpecificData.errorMessage) {
      Analytics.Instance.event(
        Analytics.Categories.RECEIVE_ADDR,
        Analytics.Actions.ERROR,
        coinSpecificData.xpubMissing ? 'Xpub missing' : undefined
      );
    }
  }, [coinSpecificData.errorMessage]);

  return (
    <Root className={classes.root}>
      <ErrorBox
        open={!!coinSpecificData.errorMessage}
        closeText={coinSpecificData.xpubMissing ? 'No' : undefined}
        handleClose={handleErrorBoxClose}
        text={coinSpecificData.errorMessage}
        actionText={coinSpecificData.xpubMissing ? 'Yes' : undefined}
        handleAction={coinSpecificData.xpubMissing ? onResyncCoins : undefined}

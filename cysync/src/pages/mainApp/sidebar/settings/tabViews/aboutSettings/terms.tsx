        ...
        <Grid container>
          ...
          <Grid item xs={10}>
            ...
            <Typography color="textPrimary">
              ...
              Before you get on, Cypherock needs you to carefully read,
              understand and accept our Terms of Use (the or these “Terms”).
            </Typography>
            <br />
            <Typography
              variant="h5"
            ...
            <Typography color="textPrimary">
              This agreement is between you (“you”, “your”, or “User”) and
              Faucet Labs Private Limited (“Cypherock”, “us”, “we,&apos;&apos;
              “our”, or the “Company”). By using or clicking “I agree” to any of
              the services provided by Cypherock or its affiliates in connection
              ...
              <br />
              <br />
              BEFORE USING THE SERVICES, PLEASE EDUCATE YOURSELF TO MAKE
              INFORMED DECISIONS. CRYPTO ASSETS ARE VOLATILE. THE PRICES CAN GO
              UP AND DOWN. CAREFULLY EVALUATE YOUR GOALS AND THE FINANCIAL RISK
            ...
            <Typography color="textPrimary">
              ...
              doubt that in these definitions, reference to the singular
              includes a reference to the plural and vice versa, except when
            ...
            <Typography color="textPrimary">
              ...
              old or qualify as an adult in your country of residence. If you
            ...
            <Typography color="textPrimary">
              ...
              proof-of-work blockchains, and to the Services. You acknowledge
              that you have been warned of the following associated risks:
              <br />
              <br />
              ...
              the Limitation of Liability section, you hereby agree that
              Cypherock shall have no liability for any loss that incurs as a
              consequence of the risks highlighted in this section.
            </Typography>
            <br />
            <br />
            <Typography
            ...
            <Typography color="textPrimary">
              The only existing backup is with you. Cypherock does not have
              access to or store passwords, 24-word Recovery Phrase, Private
              Keys, passphrases, transaction history, PIN, or other credentials
              ...
              one or more of your 24-word Recovery Phrase or PIN can gain
              control of the Private Keys associated with your Cypherock Device
              or of the 24-word Recovery Phrase;
              <br />
              <br />
            ...
            <Typography color="textPrimary">
              ...
              extract data, (iii) not to provide false, inaccurate, or
              misleading information, and (iv) not to take any action that may
              impose an unreasonable or disproportionately large load on our or
              any of our third party providers’ infrastructure.
              <br />
              <br />
              Don’t circumvent our security. You agree not to bypass,
              circumvent, or attempt to bypass or circumvent any measures that
              we may use to prevent or restrict access to Cypherock Services
              including, without limitation, Cypherock Devices connected to
              Cypherock Services, other accounts, information systems, or
              networks.
              <br />
              <br />
              Don’t break the law. You agree that you will not violate any laws
              when using Cypherock Services. This includes any local,
              provincial, state, federal, national, or international laws that
              may apply to you. You agree that you will not use Cypherock
              Services to pay for, support, or otherwise engage in any illegal
              activities including, but not limited to, fraud, illegal gambling,
              money laundering, or terrorist activities. You further agree not
              to encourage or induce any third party to engage in any of the
              ...
              <br />
              <br />
              Any use of Cypherock Services other than as specifically
              authorized in these Terms, without our prior written permission,
              is strictly prohibited and will terminate your license to use
              Cypherock Services.
            </Typography>
            <br />
            <br />
            ...
            <Typography color="textPrimary">
              ...
              that Cypherock Services can be accessed by you in accordance with
              the present Terms of Use, but there are no guarantees that access
              and features will not be interrupted or that there will be no
              delays, failures, errors, omissions, corruption or loss of
              transmitted information. Cypherock Services are provided “as is”
              without any warranty of any kind, either express or implied, and
              in particular without implied warranties of merchantability,
            ...
            <Typography color="textPrimary">
              ...
              <br />
              <br />
              Cypherock does not guarantee the correct functioning of the
              Services in the event of the installation or use of programs or
              applications that do not conform to Service specifications and
              technical standards.
              <br />
              <br />
            ...
            <Typography color="textPrimary">
              ...
              not ensure that the transactions you broadcast on Cypherock
              Services will be confirmed and processed. You acknowledge that we
              do not store, send, or receive Crypto Assets and you agree that
              the transactions you configure on Cypherock Services may fail, or
              may be substantially delayed by the underlying blockchain
              networks.
              <br />
              <br />
              ...
              impacted Crypto Asset for as long as Cypherock deems necessary.
              When it so decides, Cypherock will endeavor to give you advance
              notice, but may not be able to. You should keep yourself apprised
              of such events and make all necessary arrangements.
            </Typography>
            <br />
            <br />
            <Typography
            ...
            <Typography color="textPrimary">
              Device Applications are available for download on Cypherock
              CySync.
              <br />
              <br />
              ...
              Device Applications supported on a Cypherock Device and on
              Cypherock CySync. Cypherock may perform code reviews and conduct
              security audits of Device Applications available on Cypherock
              CySync, which does not constitute any kind of endorsement nor any
              guarantee that those applications are risk-free.
              <br />
              <br />
              ...
              access to them from Cypherock Services for any reason for as long
              as deemed necessary.
            </Typography>
            <br />
            <br />
            ...
            <Typography color="textPrimary">
              ...
              experimental features on Cypherock CySync. These features may not
              be complete and have not been fully tested, which may present
              heightened risks. They may contain errors or inaccuracies that
              could cause failures, corruption or loss of data and/or
              information. You can think of these features as beta features.
              Cypherock does not guarantee the stability, functionality, or
            ...
            <Typography color="textPrimary">
              Do not trust. Verify. Software integrity, especially when
              connected to the Internet, is very hard to verify. Cypherock’s
              security model relies on trusted display and Smartcard Security.
              This is why the verification of the information on your Cypherock
              Device is paramount. Before you approve an operation, you must
              always double check that the information displayed on your mobile
            ...
            <Typography color="textPrimary">
              ...
              identified in Cypherock CySync. Cypherock is not responsible for
              any performance, or failure to perform the Third Party Services.
              It is your responsibility to review the third party’s terms and
              policies before using a Third Party Service. Some Third Party
              Services may request or require access to your personal data. The
              processing of such data will be handled in accordance with the
              relevant Third Party’s privacy policy and best practices.
              <br />
              <br />
              ...
              concerns about how a Third Party Service operates, or need
              support, please contact the relevant third party directly.
              <br />
              <br />
              We advise not to share any credential, password, Private Key,
              passphrase, or any other sensitive information with any Third
              Party Service without validating their legitimacy first.
              <br />
              <br />
            ...
            <Typography color="textPrimary">
              ...
              <br />
              <br />
              Links to Buy Crypto services are sponsored links. The existence of
              a link to or from one of Cypherock Services does not represent or
              ...
              of staking rights to a validator operator listed in Cypherock
              CySync does not grant to your benefit any right to request payment
              of any kind, but merely a potential right to share a reward
              perceived by the validator. Please note that lock-up periods
              depend on the validator and blockchain protocols.
              <br />
              <br />
            ...
            <Typography color="textPrimary">
              YOU EXPRESSLY UNDERSTAND AND AGREE THAT CYPHEROCK AND ITS
              DIRECTORS AND EMPLOYEES SHALL NOT BE LIABLE TO YOU FOR ANY DIRECT,
              INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES,
              INCLUDING, BUT NOT LIMITED TO, DAMAGES FOR LOSS OF PROFITS,
              GOODWILL, USE, DATA, COST OF PROCUREMENT OF SUBSTITUTE GOODS OR
              SERVICES, OR OTHER INTANGIBLE LOSSES, RESULTING FROM: (I) THE USE
              OR INABILITY TO USE THE SERVICES (II) ANY CHANGES MADE TO THE
              SERVICE OR ANY SUSPENSION OR CESSATION OF THE SERVICES OR ANY PART
              THEREOF; (III) THE UNAUTHORIZED ACCESS TO OR ALTERATION OF YOUR
              TRANSMISSIONS OR DATA; (IV) THE DELETION OF, CORRUPTION OF, OR
              FAILURE TO STORE AND/OR SEND OR RECEIVE YOUR TRANSMISSIONS OR DATA
              ON OR THROUGH THE SERVICE; AND (V) ANY OTHER MATTER RELATING TO
              THE SERVICE.
              <br />
              <br />
              THE ABOVE LIMITATIONS DO NOT APPLY IN RESPECT OF LOSS RESULTING
              FROM (A) CYPHEROCK’S FRAUD, WILFUL MISCONDUCT OR GROSS NEGLIGENCE,
            ...
            <Typography color="textPrimary">
              ...
              exception of Materials released or anyway made available pursuant
              to public license agreements, open source, MIT, or other
              ...
              <br />
              <br />
              You may view, print and/or download a copy of proprietary
              Materials from Cypherock Services on any single computer solely
              for your personal, informational and/or non-commercial use,
              provided you comply with all copyright and other proprietary
              notices.
              <br />
              <br />
              The trademarks, service marks and logos of Cypherock and others
              used in the Services (“Trademarks”) are the property of Cypherock
              and their respective owners. It is strictly prohibited to use
              these Trademarks without our express written authorisation or the
            ...
            <Typography color="textPrimary">
              ...
              to or result from their obligations under these Terms. By
              accessing and using the Services, you represent and warrant that
              you are not on any trade or economic sanctions lists, such as (but
              not limited to) the UN Security Council Sanctions list, designated
              as a “Specially Designated National” by OFAC (Office of Foreign
              Assets Control of the U.S. Treasury Department) or placed on the
              U.S. Commerce Department’s “Denied Persons List”.
              <br />
              <br />
              Cypherock reserves the right to select the markets and
              jurisdictions where it operates and may restrict or deny access to
              Cypherock Services in certain countries, states or territories.
            </Typography>
            <br />
            <br />
            <Typography
            ...
            <Typography color="textPrimary">
              ...
              to suspend your access to Cypherock Services without notice if we
              ...
              <br />
              <br />
              Your access to your Wallets after termination will depend on
              whether you securely backed up your Private Keys and your Wallet
              address.
            </Typography>
            <br />
            <br />
            ...
            <Typography color="textPrimary">
              ...
              Cypherock Services. If you do not read and accept the Terms in
              their entirety you should not use or continue using Cypherock
              Services.
              <br />
              <br />
              ...
              obligations under these Terms of Use and, in such context, share
              or transfer information provided by you while using Cypherock
